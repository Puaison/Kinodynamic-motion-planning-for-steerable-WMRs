...
class prova():
    def __init__(self):
        ...
        expanded_q=np.array([0,0,1,1,1,1])
        my_u=np.array([0,0,0])
    ...
    def optimal_trajectory(self,q0,q1,tau_step,frequency):
        ...
        # self.A=np.random.rand(6, 6)
        # self.B=np.random.rand(6, 3)
        # self.c=np.random.rand(6)
        # self.A=self.model.get_linearized_A()
        # self.B=self.model.get_linearized_B()
        # self.c=self.model.get_linearized_c()
